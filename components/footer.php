<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:aashtech@gmail.com"><i class="fas fa-envelope"></i> aashtech@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Aashish</span> | all rights reserved!</div>
